...
When we were going to build our `regression models`, we compared the distributions of \"annual salary\" and \"log of annual salary\" and chose log of annual salary as our dependent variable (Y), as it fit into normal distribution more closely. Based on the exploratory data analysis, we picked our explanatory variables.
