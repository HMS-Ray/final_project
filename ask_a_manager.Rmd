...
This is the GitHub Repo for this project - https://github.com/HMS-Ray/final_project
...
- Hypothesis 2 - Difference in the proportion of tech-employees among cities: Proportion of tech-employees in San Francisco is significantly different than in other US cities.
...
- Hypothesis 4 - Difference in the proportion of Tech-employees by race: Proportion of Asians working in Tech (9.39%) is significantly different than proportion of Asians working in other industries (5.38%) as P-value < 2e-16. 

Further, we build *regression models*. We compared the distributions of \"annual salary\" and \"log of annual salary\" and chose log of annual salary as our dependent variable (Y), as it fit into normal distribution more closely. Based on the exploratory data analysis, we picked our explanatory variables.

However, we observed that all of our independent variables were categorical. If we included the variables without any manipulation and grouping, our data would have been very sparse and the model would have had a large number of variables. Hence, in order to reduce the sparsity of the data, we combined some of the categories of our explanatory variables.

After doing data manipulation and regrouping the variables, we split the data into train and test sets so that we could pick the best model based on Adjusted R squared and the RMSE on the test set. We started iterating with different regression models and picked the best model that had an Adjusted R squared of 44% and a test RMSE of 0.11. We proceeded with VIF calculation and Residual Analysis, and this model looked good. We concluded that people with poor field experiences would get a significant disadvantage on their salary, Hispanic, Latino, or Spanish origin and women were groups paid much lower, people should look for jobs in rich states if they want to have higher annual salary, professional degree gives you a greater salary boost than a PhD, and avoid education and nonprofits industries but Computing or Tech industry instead if you want to get an attractive pay.
...
> On average, as overall experience increases, the median salary increases, and the variability increases but decreases towards the end.
...
> On average, as field experience increases, the median salary increases, and the variability increases but decreases towards the end.
...
> Except the Under 18 category, the median annual salary increases as age increases. The anomalous behaviour of under 18 category could be due to less number of data points.
...
> On average, more educated people have a higher median salary, although this difference is low for High School and Some college.
...
*Observations for Hypothesis 1 from Exploratory Data Analysis*

>- Observation 1: Mean salary men > Mean salary women

```{r, mean_salary_by_gender}
#boxplots
us_data %>% 
  group_by(gender) %>% 
...
print(us_data_menvswomen, width = Inf)
...
*Observations for Hypothesis 2 from Exploratory Data Analysis*
...
*Observations for Hypothesis 3 from Exploratory Data Analysis*
...
*Observations for Hypothesis 4 from Exploratory Data Analysis*
...
>From the coefficients of the model, we can conlude that -

>1. People with poor field experiences would get a significant disadvantage on their salary.

>2. Hispanic, Latino, or Spanish origin and women were groups paid much lower.

>3. People should look for jobs in rich states if they want to have higher annual salary, professional degree gives you a greater salary boost than a PhD.

>4. Avoid education and nonprofits industries but choose Computing or Tech industry instead if you want to get an attractive pay.
